...
from semantic_mapping.dense_cloud_io import camera_labels_from_dict, save_result  # noqa: E402
...
def main():
    ...
    if args.config:
        ...
        config = payload.get("dense_cloud_mapping", {}).get("ros__parameters", payload)
    ...
    for index, path in enumerate(args.clouds):
        ...
        record = {"input": str(path.resolve()), "source_sha256": hashlib.sha256(path.read_bytes()).hexdigest(),
