...
_CONFIG_DOCS: dict[str, tuple[str, tuple[float, float] | None]] = {
    ...
    "workers": ("Threads for neighbour searches and the surface graph; -1 = all cores (results do not depend on it)",
                (-1, 1024)),
    "native_kernels": ("Build the surface graph with the compiled supermap_kernels package when installed", None),
